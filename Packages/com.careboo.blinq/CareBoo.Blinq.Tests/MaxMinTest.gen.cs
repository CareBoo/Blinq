...
internal partial class MaxMinTest
{
        ...
        )
    {
        ...
        var actual = ExceptionAndValue(() => Blinq.Max(ref srcNativeArray, SelectSelf<int>()));
        srcNativeArray.Dispose();
    }
        ...
        )
    {
        ...
        var actual = ExceptionAndValue(() => Blinq.Min(ref srcNativeArray, SelectSelf<int>()));
        srcNativeArray.Dispose();
    }
        ...
        )
    {
        ...
        var actual = ExceptionAndValue(() => Blinq.Max(ref srcNativeArray, SelectSelf<float>()));
        srcNativeArray.Dispose();
    }
        ...
        )
    {
        ...
        var actual = ExceptionAndValue(() => Blinq.Min(ref srcNativeArray, SelectSelf<float>()));
        srcNativeArray.Dispose();
    }
        ...
        )
    {
        ...
        var actual = ExceptionAndValue(() => Blinq.Max(ref srcNativeArray, SelectSelf<double>()));
        srcNativeArray.Dispose();
    }
        ...
        )
    {
        ...
        var actual = ExceptionAndValue(() => Blinq.Min(ref srcNativeArray, SelectSelf<double>()));
        srcNativeArray.Dispose();
    }
