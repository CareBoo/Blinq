...
internal class SumTest
{
        ...
        )
    {
        ...
        var actual = ExceptionAndValue(() => Blinq.Sum(ref srcNativeArray));
        ...
        )
    {
        ...
        var actual = ExceptionAndValue(() => Blinq.Sum(ref srcNativeArray, SelectSelf<int>()));
        srcNativeArray.Dispose();
    }
        ...
        )
    {
        ...
        var actual = ExceptionAndValue(() => Blinq.Sum(ref srcNativeArray, SelectSelf<float>()));
        srcNativeArray.Dispose();
    }
        ...
        )
    {
        ...
        var actual = ExceptionAndValue(() => Blinq.Sum(ref srcNativeArray, SelectSelf<double>()));
        srcNativeArray.Dispose();
    }
