...
internal class AverageTest
{
        ...
        )
    {
        ...
        var actual = ExceptionAndValue(() => Blinq.Average(ref srcNativeArray));
        ...
        )
    {
        ...
        var actual = ExceptionAndValue(() => Blinq.Average(ref srcNativeArray, SelectSelf<int>()));
        srcNativeArray.Dispose();
    }
        ...
        )
    {
        ...
        var actual = ExceptionAndValue(() => Blinq.Average(ref srcNativeArray, SelectSelf<float>()));
        srcNativeArray.Dispose();
    }
        ...
        )
    {
        ...
        var actual = ExceptionAndValue(() => Blinq.Average(ref srcNativeArray, SelectSelf<double>()));
        srcNativeArray.Dispose();
    }
